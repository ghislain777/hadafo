...
const tab = Animateuremission.rawAttributes
let table = {
    nom: "animateuremission",
    model: "Animateuremission",
    champs: [],
    contientAnimateuremission: false
}
...
const flutterPath = "../../hadafomobile"
